...
-- =========================================================
-- 🌟 1. 系统主权防伪签名表 (原 Guardian 底层护城河，现由 Flyway 接管)
-- =========================================================
CREATE TABLE IF NOT EXISTS `sys_app_signature` (
   `id` INT NOT NULL,
...
INSERT IGNORE INTO `sys_app_signature` (`id`, `sign`) VALUES (1, 'MoneyPOS');
...
-- ----------------------------
INSERT INTO `flyway_schema_history` VALUES (1, '1.0.0', 'init database.sql', 'SQL', 'V1.0.0__init_database.sql.sql', -688613554, 'root', '2026-03-20 17:45:02', 1461, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '库存单据主表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '库存单据明细表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `gms_stock_log`  (
  ...
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '库存变动流水台账表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '门店每日经营快照表' ROW_FORMAT = Dynamic;
...
INSERT INTO `oms_daily_summary` VALUES (8, '2026-03-20', 1112.92, 10, 586.22, 111.29, 56722.44, 0.00, 0, 'money', '2026-03-20 11:06:17', 'money', '2026-03-20 23:59:29', 0);
INSERT INTO `oms_daily_summary` VALUES (9, '2026-03-21', 571.40, 3, 221.60, 190.47, 56590.52, 0.00, 0, 'money', '2026-03-21 00:11:37', 'money', '2026-03-21 23:19:09', 0);
INSERT INTO `oms_daily_summary` VALUES (10, '2026-03-22', 0.00, 0, 0.00, 0.00, 0.00, 0.00, 0, 'money', '2026-03-22 00:15:47', 'money', '2026-03-22 00:52:35', 0);
...
CREATE TABLE `oms_order_pay`  (
  ...
  `original_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT '原始实收',
  `net_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT '净入账',
  `change_allocated` decimal(10, 2) NULL DEFAULT NULL COMMENT '找零分配',
  `pay_amount` decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '支付金额',
  `create_time` datetime NULL DEFAULT current_timestamp() COMMENT '支付时间',
  `tenant_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '租户ID',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_order_no`(`order_no` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '订单支付明细表 (支持动态组合支付)' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '会员满减券资产表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_dict_detail` VALUES (1775000000001, 'SYSTEM_SETTING', 'customer_display', '{\"enabled\":true,\"interval\":5,\"welcomeText\":\"欢迎光临！\",\"paymentCodes\":[{\"name\":\"微信\",\"url\":\"http://localhost:9101/money-pos/assets/2026-03-20/71756d5edf6441728ed33c24a79af283.jpg\",\"isDefault\":true},{\"name\":\"支付宝\",\"url\":\"http://localhost:9101/money-pos/assets/2026-03-20/26a40a47278849c9a550cebca88c2068.jpg\",\"isDefault\":true}],\"library\":[\"http://localhost:9101/money-pos/assets/2026-03-20/202c63b47dce45ee9536ae3994b8d6fb.png\",\"http://localhost:9101/money-pos/assets/2026-03-20/31319a503c8743e4b55567119a565604.png\",\"http://localhost:9101/money-pos/assets/2026-03-20/95857248ac6b4bb883f5991e308bb860.png\"],\"playlist\":[\"http://localhost:9101/money-pos/assets/2026-03-20/202c63b47dce45ee9536ae3994b8d6fb.png\",\"http://localhost:9101/money-pos/assets/2026-03-20/31319a503c8743e4b55567119a565604.png\",\"http://localhost:9101/money-pos/assets/2026-03-20/95857248ac6b4bb883f5991e308bb860.png\"],\"promoThreshold\":20,\"promoTemplate\":\"还差 ￥{gap} 即可享受 [{rule}]\"}', 'Customer Display Settings', 1, 0, 'admin', '2026-03-12 22:24:26', 'admin', '2026-03-12 22:24:26');
...
-- ----------------------------
INSERT INTO `sys_permission` VALUES (1501921151197130754, '系统管理', 'DIR', 0, 'sys-manage', '', 'system', 0, 0, '', '', 9, 9, 'admin', '2022-03-10 22:01:21', 'admin', '2022-03-10 23:06:45', 0);
...
INSERT INTO `sys_permission` VALUES (1629707539397672961, '品牌', 'MENU', 1629707272975482881, 'gms-brand', 'gmsBrand:list', 'gmsbrand', 0, 0, 'GmsBrand', 'gms/brand/index', 3, 2, 'money', '2023-02-26 12:58:51', 'money', '2023-02-26 12:58:51', 0);
...
INSERT INTO `sys_permission` VALUES (1629731562059952129, '商品', 'MENU', 1629707272975482881, 'gms-goods', 'gmsGoods:list', 'gmsgoods', 0, 0, 'GmsGoods', 'gms/goods/index', 1, 1, 'money', '2023-02-26 14:34:18', 'money', '2023-02-26 14:34:18', 0);
...
INSERT INTO `sys_permission` VALUES (1629732239595237378, '销售单据', 'MENU', 1629732061718999041, 'oms-order', 'omsOrder:list', 'omsorder', 0, 0, 'OmsOrder', 'oms/order/index', 1, 1, 'money', '2023-02-26 14:37:00', 'money', '2023-02-26 14:37:00', 0);
...
INSERT INTO `sys_permission` VALUES (2028143215712141312, '满减券规则', 'MENU', 1629732061718999041, 'app', 'posCouponRule:list', 'couponRule', 0, 0, 'CouponRule', 'pos/couponRule/index', 0, 6, 'money', '2026-03-02 00:19:58', 'money', '2026-03-02 00:19:58', 0);
...
INSERT INTO `sys_permission` VALUES (2028504406275944448, '今日财务大屏', 'MENU', 2028301216125370368, 'app', '', 'dashboard', 0, 0, 'Financedashboard', 'finance/index', 0, 1, 'money', '2026-03-03 00:15:13', 'money', '2026-03-03 00:15:13', 0);
INSERT INTO `sys_permission` VALUES (2028510077331451904, '利润暴击榜', 'MENU', 2028301216125370368, 'app', '', 'financeprofit-ranking', 0, 0, 'FinanceProfitRanking', 'finance/profitRanking', 0, 2, 'money', '2026-03-03 00:37:45', 'money', '2026-03-03 00:37:45', 0);
INSERT INTO `sys_permission` VALUES (2028510921267359744, '交接班对账单', 'MENU', 2028301216125370368, 'app', '', 'financeshifthandover', 0, 0, 'FinanceHandover', 'finance/shiftHandover', 0, 3, 'money', '2026-03-03 00:41:06', 'money', '2026-03-03 00:41:06', 0);
INSERT INTO `sys_permission` VALUES (2028821585810722816, '套餐管理', 'MENU', 1629707272975482881, 'app', '', 'gmscombo', 0, 0, 'GmsCombo', 'gms/combo/index', 0, 3, 'money', '2026-03-03 21:15:34', 'money', '2026-03-03 21:15:34', 0);
INSERT INTO `sys_permission` VALUES (2028856000175693824, '采购入库', 'MENU', 2028301917203283968, 'app', '', 'gmsinbound', 0, 0, 'GmsInbound', 'gms/inventory/inbound/index', 0, 1, 'money', '2026-03-03 23:32:19', 'money', '2026-03-03 23:32:19', 0);
INSERT INTO `sys_permission` VALUES (2028868371698999296, '库存盘点', 'MENU', 2028301917203283968, 'app', '', 'gmscheck', 0, 0, 'GmsCheck', 'gms/inventory/check/index', 0, 2, 'money', '2026-03-04 00:21:29', 'money', '2026-03-04 00:21:29', 0);
INSERT INTO `sys_permission` VALUES (2028869083472388096, '报损出库', 'MENU', 2028301917203283968, 'app', '', 'gmsoutbound', 0, 0, 'GmsOutbound', 'gms/inventory/outbound/index', 0, 3, 'money', '2026-03-04 00:24:19', 'money', '2026-03-04 00:24:19', 0);
...
INSERT INTO `sys_permission` VALUES (2029771654781243392, '库存流水', 'MENU', 2028301917203283968, 'app', '', 'gmsstockLog', 0, 0, 'GmsStockLog', 'gms/stockLog/index', 0, 4, 'money', '2026-03-06 12:10:48', 'money', '2026-03-06 12:10:48', 0);
...
INSERT INTO `sys_permission` VALUES (2030958188601368576, '支付渠道占比分析', 'MENU', 2028301216125370368, 'app', '', 'financechannel', 0, 0, 'FinanceChannel', 'finance/channel/index', 0, 6, 'money', '2026-03-09 18:45:40', 'money', '2026-03-09 18:45:40', 0);
INSERT INTO `sys_permission` VALUES (2030966563355611136, '收银风控雷达', 'MENU', 2028301216125370368, 'app', '', 'financerisk', 0, 0, 'FinanceRisk', 'finance/risk/index', 0, 7, 'money', '2026-03-09 19:18:57', 'money', '2026-03-09 19:18:57', 0);
INSERT INTO `sys_permission` VALUES (2030978510369181696, '销售大盘', 'MENU', 1629732061718999041, 'app', '', 'oms/analysis', 0, 0, 'OmsAnalysis', 'oms/analysis/index', 0, 2, 'money', '2026-03-09 20:06:25', 'money', '2026-03-09 20:06:25', 0);
INSERT INTO `sys_permission` VALUES (2030982909879402496, '经营业绩汇总报表', 'MENU', 1629732061718999041, 'app', '', 'oms/report', 0, 0, 'OmsReport', 'oms/report/index', 0, 3, 'money', '2026-03-09 20:23:54', 'money', '2026-03-09 20:23:54', 0);
INSERT INTO `sys_permission` VALUES (2031005190381129728, '进销存分析报表', 'MENU', 2028301917203283968, 'app', '', 'gmsanalysis', 0, 0, 'GmsAnalysis', 'gms/analysis/index', 0, 5, 'money', '2026-03-09 21:52:26', 'money', '2026-03-09 21:52:26', 0);
...
INSERT INTO `sys_permission` VALUES (2034109226911330304, '客流价值分析', 'MENU', 2034114170099884032, 'app', '', 'omsanalysistraffic', 0, 0, 'OmsAnalysisTraffic', 'oms/analysis/traffic', 0, 1, 'money', '2026-03-18 11:26:46', 'money', '2026-03-18 11:26:46', 0);
INSERT INTO `sys_permission` VALUES (2034114170099884032, '决策看板', 'DIR', 0, 'app', '', 'DecisionDashboards', 0, 0, '', '', 2, 6, 'money', '2026-03-18 11:46:24', 'money', '2026-03-18 11:46:24', 0);
INSERT INTO `sys_permission` VALUES (2034115775750758400, '周转预警中心', 'MENU', 2034114170099884032, 'app', '', 'gmsturnover', 0, 0, 'GmsTurnover', 'gms/analysis/turnover', 0, 3, 'money', '2026-03-18 11:52:47', 'money', '2026-03-18 11:52:47', 0);
...
INSERT INTO `sys_permission` VALUES (2034211994464423936, '潮汐趋势分析', 'MENU', 2034114170099884032, 'app', '', 'omsanalysistide', 0, 0, 'OmsAnalysistide', 'oms/analysis/tide', 0, 2, 'money', '2026-03-18 18:15:07', 'money', '2026-03-18 18:15:07', 0);
INSERT INTO `sys_permission` VALUES (2034239761453174784, '会员排行', 'MENU', 1629388418109894657, 'app', '', 'umsrank', 0, 0, 'Umsrank', 'ums/rank/index', 0, 2, 'money', '2026-03-18 20:05:28', 'money', '2026-03-18 20:05:28', 0);
...
INSERT INTO `sys_permission` VALUES (2034952993616719872, '一键备份/还原', 'MENU', 1501921151197130754, 'app', '', 'Systembackup', 0, 0, 'Systembackup', 'system/backup/index', 0, 9, 'money', '2026-03-20 19:19:35', 'money', '2026-03-20 19:19:35', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '会员本金与存券变动流水表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_recharge_order`  (
  ...
  UNIQUE INDEX `uk_order_no`(`order_no` ASC) USING BTREE,
  INDEX `idx_member_id`(`member_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '充值业务凭证表' ROW_FORMAT = Dynamic;
