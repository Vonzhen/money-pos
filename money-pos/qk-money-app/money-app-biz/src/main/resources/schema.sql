...
-- ----------------------------
INSERT INTO `gms_brand` VALUES (2029044459821604864, '', '绿叶', '', 5, 'money', '2026-03-04 12:01:12', 'money', '2026-03-04 12:01:12', 0);
INSERT INTO `gms_brand` VALUES (2029044546069078016, '', '宛伊', '', 1, 'money', '2026-03-04 12:01:32', 'money', '2026-03-04 12:01:32', 0);
INSERT INTO `gms_brand` VALUES (2029044567510360064, '', '孝慈', '', 0, 'money', '2026-03-04 12:01:37', 'money', '2026-03-04 12:01:37', 0);
INSERT INTO `gms_brand` VALUES (2030123392182534144, '', '艾美', '', 0, 'money', '2026-03-07 11:28:29', 'money', '2026-03-07 11:28:29', 0);
...
-- ----------------------------
INSERT INTO `gms_goods` VALUES (2030133785449852928, 2029044459821604864, 2029044667410292736, '60313', '测试日用', '', '', '', '', '', 3.00, 9.00, 0.00, 0.00, 46.000, 0, 'SALE', 'money', '2026-03-07 12:09:47', 'money', '2026-03-07 12:09:47', 0, 1, 'CSRY', 0);
INSERT INTO `gms_goods` VALUES (2030133958737522688, 2029044546069078016, NULL, '000000', '测试宛伊', '', '', '', '', '', 60.00, 168.00, 0.00, 0.00, -2843.000, 0, 'SALE', 'money', '2026-03-07 12:10:28', 'money', '2026-03-07 12:10:28', 0, 0, 'CSWY', 0);
INSERT INTO `gms_goods` VALUES (2030149135247622144, 2029044459821604864, 2029044667410292736, '60320', '测试夜用', '', '', '', '', '', 3.00, 9.00, 0.00, 0.00, 349.000, 0, 'SALE', 'money', '2026-03-07 13:10:47', 'money', '2026-03-07 13:10:47', 0, 1, 'CSYY', 0);
INSERT INTO `gms_goods` VALUES (2030167929437319168, 2029044459821604864, NULL, '60337', '测试夜用加长', '', '', '', '', '', 3.00, 11.00, 0.00, 0.00, 44.000, 0, 'SALE', 'money', '2026-03-07 14:25:28', 'money', '2026-03-07 14:25:28', 0, 1, 'CSYYJZ', 0);
INSERT INTO `gms_goods` VALUES (2030473430092042240, NULL, NULL, '303333', '测试套餐', '', '', '', '', '测试', 0.00, 99.00, 0.00, 0.00, 999999.000, 0, 'SALE', 'money', '2026-03-08 10:39:25', 'money', '2026-03-08 10:39:25', 0, 1, 'CSTC', 1);
INSERT INTO `gms_goods` VALUES (2030560888028782592, 2029044459821604864, NULL, '60341', '测试牙膏', '', '', '', '', '', 5.00, 9.91, 0.00, 0.00, 4970.000, 0, 'SALE', 'money', '2026-03-08 16:26:56', 'money', '2026-03-08 16:26:56', 0, 1, 'CSYG', 0);
...
-- ----------------------------
INSERT INTO `gms_goods_category` VALUES (2029044667410292736, 0, '', '个护美妆', 3, 'money', '2026-03-04 12:02:01', 'money', '2026-03-04 12:02:01', 0);
INSERT INTO `gms_goods_category` VALUES (2029044718467555328, 0, '', '家清厨卫', 0, 'money', '2026-03-04 12:02:13', 'money', '2026-03-04 12:02:13', 0);
...
CREATE TABLE `gms_goods_combo`  (
  ...
  `combo_goods_id` bigint NOT NULL COMMENT '套餐商品ID (指向 gms_goods 表的主键)',
  `sub_goods_id` bigint NOT NULL COMMENT '子单品ID (指向 gms_goods 表的主键)',
  `sub_goods_qty` int NOT NULL DEFAULT 1 COMMENT '包含该单品的数量',
...
CREATE TABLE `gms_inventory_order`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户ID (多租户隔离必备)',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `gms_inventory_order_detail`  (
  `id` bigint NOT NULL COMMENT '主键ID',
  `order_id` bigint NOT NULL COMMENT '关联的主单据ID',
  `goods_id` bigint NOT NULL COMMENT '关联的商品ID (gms_goods)',
  `qty` int NOT NULL COMMENT '变动数量 (进货填正数，报损填正数，盘点填实际数量)',
...
CREATE TABLE `gms_member_transaction`  (
  `id` bigint NOT NULL COMMENT '主键ID',
  `member_id` bigint NOT NULL COMMENT '关联的会员ID (gms_member表)',
...
CREATE TABLE `gms_promotion_goods`  (
  ...
  `goods_id` bigint NOT NULL COMMENT '参与活动的商品ID',
...
CREATE TABLE `gms_stock_log`  (
  ...
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 71 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '库存变动流水台账表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of gms_stock_log
-- ----------------------------
INSERT INTO `gms_stock_log` VALUES (1, 1488070069522055170, '夜用', '6955470960320', 'SALE', -1.000, 50.000, '202603061157229', '前台收银售出', '2026-03-06 11:57:22', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (2, 1488071281298423809, '加长360', '6955470960337', 'SALE', -1.000, 47.000, '202603061212006', '前台收银售出', '2026-03-06 12:12:00', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (3, 1488070069522055170, '夜用', '6955470960320', 'SALE', -2.000, 50.000, '202603061212006', '前台收银售出', '2026-03-06 12:12:00', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (4, 1488070478168899586, '日用', '6955470960313', 'SALE', -1.000, 140.000, '202603061212006', '前台收银售出', '2026-03-06 12:12:00', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (5, 1488071281298423809, '加长360', '6955470960337', 'SCRAP', -1.000, 46.000, 'OU202603061212579680', '后台报损出库：破损', '2026-03-06 12:12:58', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (6, 1488070478168899586, '日用', '6955470960313', 'SALE', -20.000, 140.000, '202603061224334', '前台收银售出', '2026-03-06 12:24:33', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (7, 1487743593950072833, '护垫', '6955470960344', 'SALE', -20.000, 46.000, '202603062001011', '前台收银售出', '2026-03-06 20:01:02', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (8, 1488070478168899586, '日用', '6955470960313', 'SALE', -1.000, 140.000, '202603062001011', '前台收银售出', '2026-03-06 20:01:02', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (9, 1488073045384937473, '洋甘菊眼罩', '6955470983787', 'SALE', -10.000, 0.000, '202603062009325', '前台收银售出', '2026-03-06 20:09:33', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (10, 1488079493057789954, '绿茶眼罩', '6955470983800', 'SALE', -7.000, 0.000, '202603062021545', '前台收银售出', '2026-03-06 20:21:55', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (11, 1488079493057789954, '绿茶眼罩', '6955470983800', 'SALE', -6.000, 0.000, '202603062041118', '前台收银售出', '2026-03-06 20:41:12', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (12, 1488079493057789954, '绿茶眼罩', '6955470983800', 'SALE', -6.000, 0.000, '202603062042351', '前台收银售出', '2026-03-06 20:42:36', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (13, 1488072124630351874, '臻享迷你巾', '6955470939777', 'SALE', -20.000, 25.000, '202603062051003', '前台收银售出', '2026-03-06 20:51:00', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (14, 1488070478168899586, '日用', '6955470960313', 'SALE', -10.000, 140.000, '202603062053027', '前台收银售出', '2026-03-06 20:53:02', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (15, 1487743593950072833, '护垫', '6955470960344', 'SALE', -10.000, 46.000, '202603062053027', '前台收银售出', '2026-03-06 20:53:02', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (16, 1488073045384937473, '洋甘菊眼罩', '6955470983787', 'SALE', -10.000, 0.000, '202603062109224', '前台收银售出', '2026-03-06 21:09:23', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (17, 1488073045384937473, '洋甘菊眼罩', '6955470983787', 'RETURN', 1.000, 0.000, '202603062109224', '单品售后退货', '2026-03-06 21:10:37', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (18, 2030133785449852928, '测试日用', '60313', 'SALE', -20.000, 100.000, '202603071234228', '前台多品牌智能收银售出', '2026-03-07 12:34:23', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (19, 2030133958737522688, '测试宛伊', '000000', 'SALE', -1.000, 100.000, '202603071234228', '前台多品牌智能收银售出', '2026-03-07 12:34:23', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (20, 2030133958737522688, '测试宛伊', '000000', 'SALE', -1.000, 100.000, '202603071312097', '前台多品牌智能收银售出', '2026-03-07 13:12:10', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (21, 2030133785449852928, '测试日用', '60313', 'SALE', -2.000, 100.000, '202603071312097', '前台多品牌智能收银售出', '2026-03-07 13:12:10', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (22, 2030133958737522688, '测试宛伊', '000000', 'SALE', -1.000, 100.000, '202603071315423', '前台多品牌智能收银售出', '2026-03-07 13:15:42', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (23, 2030149135247622144, '测试夜用', '60320', 'SALE', -10.000, 500.000, '202603071315423', '前台多品牌智能收银售出', '2026-03-07 13:15:42', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (24, 2030133785449852928, '测试日用', '60313', 'SALE', -10.000, 100.000, '202603071315423', '前台多品牌智能收银售出', '2026-03-07 13:15:42', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (25, 2030133785449852928, '测试日用', '60313', 'INBOUND', 1.000, 101.000, 'IN202603080016268339', '后台采购入库：前台极速补货', '2026-03-08 00:16:27', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (26, 2030133958737522688, '测试宛伊', '000000', 'INBOUND', 1.000, 101.000, 'IN202603080016479211', '后台采购入库：前台极速补货', '2026-03-08 00:16:48', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (27, 2030149135247622144, '测试夜用', '60320', 'SALE', -25.000, 475.000, '202603080104027', '前台智能收银售出', '2026-03-08 01:04:03', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (28, 2030167929437319168, '测试夜用加长', '60337', 'SALE', -20.000, 80.000, '202603080109163', '前台智能收银售出', '2026-03-08 01:09:16', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (29, 2030167929437319168, '测试夜用加长 (套餐:测试套餐 子件)', '60337', 'SALE', -1.000, 79.000, '202603081040509', '前台套餐售出联动扣除', '2026-03-08 10:40:51', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (30, 2030149135247622144, '测试夜用 (套餐:测试套餐 子件)', '60320', 'SALE', -1.000, 474.000, '202603081040509', '前台套餐售出联动扣除', '2026-03-08 10:40:51', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (31, 2030133785449852928, '测试日用 (套餐:测试套餐 子件)', '60313', 'SALE', -1.000, 100.000, '202603081040509', '前台套餐售出联动扣除', '2026-03-08 10:40:51', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (32, 2030133785449852928, '测试日用', '60313', 'SALE', -50.000, 50.000, '202603081130531', '前台智能收银售出', '2026-03-08 11:30:54', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (33, 2030133958737522688, '测试宛伊', '000000', 'SALE', -2.000, 99.000, '202603081130531', '前台智能收银售出', '2026-03-08 11:30:54', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (34, 2030149135247622144, '测试夜用', '60320', 'SALE', -10.000, 464.000, '202603081130531', '前台智能收银售出', '2026-03-08 11:30:54', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (35, 2030149135247622144, '测试夜用', '60320', 'SALE', -22.000, 442.000, '202603081317125', '前台智能收银售出', '2026-03-08 13:17:13', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (36, 2030149135247622144, '测试夜用', '60320', 'RETURN', 1.000, 442.000, '202603081317125', '单品售后退货', '2026-03-08 13:46:56', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (37, 2030149135247622144, '测试夜用', '60320', 'RETURN', 1.000, 442.000, '202603081317125', '单品售后退货', '2026-03-08 13:49:57', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (38, 2030149135247622144, '测试夜用', '60320', 'INBOUND', 1.000, 443.000, 'IN202603081351456906', '后台采购入库', '2026-03-08 13:51:46', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (39, 2030149135247622144, '测试夜用', '60320', 'RETURN', 1.000, 444.000, '202603081317125', '单品售后退货', '2026-03-08 14:07:43', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (40, 2030149135247622144, '测试夜用', '60320', 'RETURN', 1.000, 445.000, '202603081317125', '单品售后退货', '2026-03-08 14:07:52', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (41, 2030149135247622144, '测试夜用', '60320', 'RETURN', 1.000, 446.000, '202603081317125', '单品售后退货', '2026-03-08 14:08:20', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (42, 2030133958737522688, '测试宛伊', '000000', 'INBOUND', 1.000, 100.000, 'IN202603081433021912', '后台采购入库：前台采购入库', '2026-03-08 14:33:02', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (43, 2030133785449852928, '测试日用', '60313', 'INBOUND', 1.000, 51.000, 'IN202603081433021912', '后台采购入库：前台采购入库', '2026-03-08 14:33:02', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (44, 2030167929437319168, '测试夜用加长', '60337', 'INBOUND', 1.000, 80.000, 'IN202603081433021912', '后台采购入库：前台采购入库', '2026-03-08 14:33:03', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (45, 2030149135247622144, '测试夜用', '60320', 'INBOUND', 1.000, 447.000, 'IN202603081433021912', '后台采购入库：前台采购入库', '2026-03-08 14:33:03', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (46, 2030149135247622144, '测试夜用', '60320', 'RETURN', 1.000, 448.000, '202603081317125', '单品售后退货', '2026-03-08 15:07:57', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (47, 2030149135247622144, '测试夜用', '60320', 'RETURN', 1.000, 449.000, '202603081317125', '单品售后退货', '2026-03-08 15:08:42', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (48, 2030149135247622144, '测试夜用', '60320', 'RETURN', 1.000, 450.000, '202603081317125', '单品售后退货', '2026-03-08 15:12:43', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (49, 2030149135247622144, '测试夜用', '60320', 'SALE', -50.000, 400.000, '202603081615544', '前台智能收银售出', '2026-03-08 16:15:55', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (50, 2030133785449852928, '测试日用', '60313', 'SALE', -1.000, 50.000, '202603081615544', '前台智能收银售出', '2026-03-08 16:15:55', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (51, 2030133958737522688, '测试宛伊', '000000', 'SALE', -996.000, -896.000, '202603081623279', '前台智能收银售出', '2026-03-08 16:23:27', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (52, 2030149135247622144, '测试夜用', '60320', 'SALE', -20.000, 380.000, '202603081623279', '前台智能收银售出', '2026-03-08 16:23:27', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (53, 2030133958737522688, '测试宛伊', '000000', 'SALE', -965.000, -1861.000, '202603081625176', '前台智能收银售出', '2026-03-08 16:25:17', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (54, 2030167929437319168, '测试夜用加长', '60337', 'SALE', -35.000, 45.000, '202603081625176', '前台智能收银售出', '2026-03-08 16:25:17', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (55, 2030560888028782592, '测试牙膏', '60341', 'SALE', -31.000, 4969.000, '202603081628382', '前台智能收银售出', '2026-03-08 16:28:39', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (56, 2030133958737522688, '测试宛伊', '000000', 'SALE', -982.000, -2843.000, '202603081628382', '前台智能收银售出', '2026-03-08 16:28:39', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (57, 2030560888028782592, '测试牙膏', '60341', 'RETURN', 1.000, 4970.000, '202603081628382', '单品售后退货', '2026-03-08 17:41:10', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (58, 2030133958737522688, '测试宛伊', '000000', 'RETURN', 1.000, -2842.000, '202603081628382', '单品售后退货', '2026-03-08 17:41:15', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (59, 2030560888028782592, '测试牙膏', '60341', 'RETURN', 1.000, 4971.000, '202603081628382', '单品售后退货', '2026-03-08 17:41:29', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (60, 2030149135247622144, '测试夜用', '60320', 'SALE', -30.000, 350.000, '202603091149160', '前台智能收银售出', '2026-03-09 11:49:17', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (61, 2030133785449852928, '测试日用', '60313', 'SALE', -1.000, 49.000, '202603091149160', '前台智能收银售出', '2026-03-09 11:49:17', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (62, 2030133958737522688, '测试宛伊', '000000', 'SALE', -1.000, -2843.000, '202603091149160', '前台智能收银售出', '2026-03-09 11:49:17', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (63, 2030133785449852928, '测试日用', '60313', 'SALE', -1.000, 48.000, '202603110022157', '前台智能收银售出', '2026-03-11 00:22:16', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (64, 2030149135247622144, '测试夜用', '60320', 'SALE', -1.000, 349.000, '202603110022284', '前台智能收银售出', '2026-03-11 00:22:29', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (65, 2030167929437319168, '测试夜用加长', '60337', 'SALE', -1.000, 44.000, '202603110022417', '前台智能收银售出', '2026-03-11 00:22:41', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (66, 2030560888028782592, '测试牙膏', '60341', 'SALE', -1.000, 4970.000, '202603110022578', '前台智能收银售出', '2026-03-11 00:22:57', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (67, 2030133785449852928, '测试日用', '60313', 'SALE', -1.000, 47.000, '202603111106330', '前台智能收银售出', '2026-03-11 11:06:33', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (68, 2030133785449852928, '测试日用', '60313', 'RETURN', 1.000, 48.000, '202603111106330', '整单退款，商品退回仓库', '2026-03-11 11:12:08', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (69, 2030133785449852928, '测试日用', '60313', 'SALE', -1.000, 47.000, '202603111310564', '前台智能收银售出', '2026-03-11 13:10:56', NULL, 0);
INSERT INTO `gms_stock_log` VALUES (70, 2030133785449852928, '测试日用', '60313', 'SALE', -1.000, 46.000, '202603111311317', '前台智能收银售出', '2026-03-11 13:11:32', NULL, 0);
...
-- ----------------------------
INSERT INTO `oms_order` VALUES (2028323606679044096, '202603021216460', '内部', 2028131401997746176, 1, 'PAID', '18033333333', '福建省', '泉州市', '南安', '', 500.00, 450.00, 300.00, 150.00, 300.00, '', '2026-03-02 12:16:47', NULL, 'money', '2026-03-02 12:16:47', 'money', '2026-03-02 12:16:47', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2028324090416513024, '202603021218429', '内部', 2028131401997746176, 1, 'PAID', '18033333333', '福建省', '泉州市', '南安', '', 100.00, 500.00, 200.00, 300.00, 200.00, '', '2026-03-02 12:18:42', NULL, 'money', '2026-03-02 12:18:42', 'money', '2026-03-02 12:18:42', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2028456145263554560, '202603022103261', '内部', 2028131401997746176, 1, 'PAID', '18033333333', '福建省', '泉州市', '南安', '', 200.00, 180.00, 110.00, 60.00, 110.00, '', '2026-03-02 21:03:26', NULL, 'money', '2026-03-02 21:03:27', 'money', '2026-03-02 21:03:27', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2028456816540938240, '202603022106068', '内部', 2028131401997746176, 1, 'PAID', '18033333333', '福建省', '泉州市', '南安', '', 620.82, 594.00, 370.00, 204.00, 370.00, '', '2026-03-02 21:06:07', NULL, 'money', '2026-03-02 21:06:07', 'money', '2026-03-02 21:06:07', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2028462940556107776, '202603022130269', '内部', 2028131401997746176, 1, 'PAID', '18033333333', '福建省', '泉州市', '南安', '', 100.00, 90.00, 60.00, 30.00, 60.00, '', '2026-03-02 21:30:27', NULL, 'money', '2026-03-02 21:30:27', 'money', '2026-03-02 21:30:27', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2028497769574227968, '202603022348501', '黄金', 2028131235764895744, 1, 'PAID', '18011111111', '福建省', '泉州市', '南安', '', 200.00, 180.00, 150.00, 20.00, 150.00, '', '2026-03-02 23:48:51', NULL, 'money', '2026-03-02 23:48:51', 'money', '2026-03-02 23:48:51', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2028498367346434048, '202603022351133', '黄金', 2028131235764895744, 1, 'PAID', '18011111111', '福建省', '泉州市', '南安', '', 200.00, 180.00, 150.00, 20.00, 150.00, '', '2026-03-02 23:51:13', NULL, 'money', '2026-03-02 23:51:13', 'money', '2026-03-02 23:51:13', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2028498858449100800, '202603022353106', '黄金', 2028131235764895744, 1, 'PAID', '18011111111', '福建省', '泉州市', '南安', '', 400.00, 360.00, 290.00, 40.00, 290.00, '', '2026-03-02 23:53:10', NULL, 'money', '2026-03-02 23:53:10', 'money', '2026-03-02 23:53:10', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2028499652615397376, '202603022356197', '黄金', 2028131235764895744, 1, 'PAID', '18011111111', '福建省', '泉州市', '南安', '', 200.00, 180.00, 150.00, 20.00, 150.00, '', '2026-03-02 23:56:20', NULL, 'money', '2026-03-02 23:56:20', 'money', '2026-03-02 23:56:20', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2028501921188573184, '202603030005207', '黄金', 2028131235764895744, 1, 'PAID', '18011111111', '福建省', '泉州市', '南安', '', 200.00, 180.00, 160.00, 20.00, 160.00, '', '2026-03-03 00:05:20', NULL, 'money', '2026-03-03 00:05:20', 'money', '2026-03-03 00:05:20', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2029403819747856384, '202603051149091', '黄金', 2028131235764895744, 1, 'PAID', '18011111111', '福建省', '泉州市', '南安', '', 173.50, 450.00, 230.00, 200.00, 230.00, '', '2026-03-05 11:49:10', NULL, 'money', '2026-03-05 11:49:10', 'money', '2026-03-05 11:49:10', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2029405175393046528, '202603051154325', '黄金', 2028131235764895744, 1, 'PAID', '18011111111', '福建省', '泉州市', '南安', '', 173.50, 450.00, 230.00, 200.00, 230.00, '', '2026-03-05 11:54:33', NULL, 'money', '2026-03-05 11:54:33', 'money', '2026-03-05 11:54:33', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2029412683520200704, '202603051224225', '黄金', 2028131235764895744, 1, 'PAID', '18011111111', '福建省', '泉州市', '南安', '', 104.10, 270.00, 140.00, 120.00, 130.00, '', '2026-03-05 12:24:23', NULL, 'money', '2026-03-05 12:24:23', 'money', '2026-03-05 12:24:23', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2029414273085919232, '202603051230420', '黄金', 2028131235764895744, 1, 'PAID', '18011111111', '福建省', '泉州市', '南安', '', 86.75, 225.00, 115.00, 0.00, 115.00, '', '2026-03-05 12:30:42', NULL, 'money', '2026-03-05 12:30:42', 'money', '2026-03-05 12:30:42', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2029495188164292608, '202603051752138', '黄金', 2028131235764895744, 1, 'RETURN', '18011111111', '福建省', '泉州市', '南安', '', 104.10, 270.00, 140.00, 120.00, 0.00, '', '2026-03-05 17:52:14', NULL, 'money', '2026-03-05 17:52:14', 'money', '2026-03-05 17:52:14', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2029522051410538496, '202603051938583', '零售', 0, 0, 'RETURN', '', '', '', '', '', 3.47, 9.00, 9.00, 0.00, 0.00, '', '2026-03-05 19:38:58', NULL, 'money', '2026-03-05 19:38:58', 'money', '2026-03-05 19:38:58', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2029525028372328448, '202603051950484', '黄金', 2028131235764895744, 1, 'RETURN', '18011111111', '福建省', '泉州市', '南安', '', 16.20, 41.00, 22.00, 19.00, 0.00, '', '2026-03-05 19:50:48', NULL, 'money', '2026-03-05 19:50:48', 'money', '2026-03-05 19:50:48', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2029748995100016640, '202603061040450', '测试', 2029176730239180800, 1, 'PAID', '18066666666', '', '', '', '', 69.40, 180.00, 90.00, 80.00, 90.00, '', '2026-03-06 10:40:46', NULL, 'money', '2026-03-06 10:40:46', 'money', '2026-03-06 10:40:46', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2029752045797670912, '202603061052534', '测试', 2029176730239180800, 1, 'PAID', '18066666666', '', '', '', '', 3.47, 9.00, 5.00, 4.00, 5.00, '', '2026-03-06 10:52:53', NULL, 'money', '2026-03-06 10:52:53', 'money', '2026-03-06 10:52:53', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2029768273039753216, '202603061157229', '测试', 2029176730239180800, 1, 'PAID', '18066666666', '', '', '', '', 3.47, 9.00, 5.00, 4.00, 5.00, '', '2026-03-06 11:57:22', NULL, 'money', '2026-03-06 11:57:22', 'money', '2026-03-06 11:57:22', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2029771955814830080, '202603061212006', '黄金', 2028131235764895744, 1, 'PAID', '18011111111', '福建省', '泉州市', '南安', '', 15.54, 39.50, 21.50, 18.00, 21.50, '', '2026-03-06 12:12:00', NULL, 'money', '2026-03-06 12:12:00', 'money', '2026-03-06 12:12:00', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2029775115065286656, '202603061224334', '测试', 2029176730239180800, 1, 'PAID', '18066666666', '', '', '', '', 69.40, 180.00, 90.00, 80.00, 90.00, '', '2026-03-06 12:24:33', NULL, 'money', '2026-03-06 12:24:33', 'money', '2026-03-06 12:24:33', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2029889990642999296, '202603062001011', '测试', 2029176730239180800, 1, 'PAID', '18066666666', '', '', '', '', 94.27, 229.00, 115.00, 104.00, 115.00, '', '2026-03-06 20:01:02', NULL, 'money', '2026-03-06 20:01:02', 'money', '2026-03-06 20:01:02', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2029892132724305920, '202603062009325', '测试', 2029176730239180800, 1, 'PAID', '18066666666', '', '', '', '', 170.00, 290.00, 180.00, 100.00, 180.00, '', '2026-03-06 20:09:33', NULL, 'money', '2026-03-06 20:09:33', 'money', '2026-03-06 20:09:33', 0, 10.00, 0.00);
INSERT INTO `oms_order` VALUES (2029895245778702336, '202603062021545', '测试', 2029176730239180800, 1, 'PAID', '18066666666', '', '', '', '', 119.00, 203.00, 123.00, 70.00, 123.00, '', '2026-03-06 20:21:55', NULL, 'money', '2026-03-06 20:21:55', 'money', '2026-03-06 20:21:55', 0, 10.00, 0.00);
INSERT INTO `oms_order` VALUES (2029900098978467840, '202603062041118', '测试', 2029176730239180800, 1, 'PAID', '18066666666', '', '', '', '', 102.00, 174.00, 104.00, 60.00, 104.00, '', '2026-03-06 20:41:12', NULL, 'money', '2026-03-06 20:41:12', 'money', '2026-03-06 20:41:12', 0, 10.00, 0.00);
INSERT INTO `oms_order` VALUES (2029900449991380992, '202603062042351', '测试', 2029176730239180800, 1, 'PAID', '18066666666', '', '', '', '', 102.00, 174.00, 104.00, 60.00, 104.00, '', '2026-03-06 20:42:36', NULL, 'money', '2026-03-06 20:42:36', 'money', '2026-03-06 20:42:36', 0, 10.00, 0.00);
INSERT INTO `oms_order` VALUES (2029902565967417344, '202603062051003', '测试', 2029176730239180800, 1, 'PAID', '18066666666', '', '', '', '', 94.40, 240.00, 108.00, 120.00, 108.00, '', '2026-03-06 20:51:00', NULL, 'money', '2026-03-06 20:51:00', 'money', '2026-03-06 20:51:00', 0, 10.00, 2.00);
INSERT INTO `oms_order` VALUES (2029903077202743296, '202603062053027', '测试', 2029176730239180800, 1, 'PAID', '18066666666', '', '', '', '', 80.10, 200.00, 97.00, 90.00, 97.00, '', '2026-03-06 20:53:02', NULL, 'money', '2026-03-06 20:53:02', 'money', '2026-03-06 20:53:02', 0, 10.00, 3.00);
INSERT INTO `oms_order` VALUES (2029907190288281600, '202603062109224', '测试', 2029176730239180800, 1, 'PAID', '18066666666', '', '', '', '', 170.00, 290.00, 179.00, 100.00, 160.00, '', '2026-03-06 21:09:23', NULL, 'money', '2026-03-06 21:09:23', 'money', '2026-03-06 21:09:23', 0, 10.00, 1.00);
INSERT INTO `oms_order` VALUES (2030139973654568960, '202603071234228', '测试', 2030139388972785664, 1, 'PAID', '13844444444', '', '', '', '', 120.00, 290.00, 220.00, 70.00, 220.00, '', '2026-03-07 12:34:23', NULL, 'money', '2026-03-07 12:34:23', 'money', '2026-03-07 12:34:23', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2030149483190304768, '202603071312097', '测试', 2030139388972785664, 1, 'PAID', '13844444444', '', '', '', '', 66.00, 128.00, 121.00, 7.00, 121.00, '', '2026-03-07 13:12:10', NULL, 'money', '2026-03-07 13:12:10', 'money', '2026-03-07 13:12:10', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2030150373854953472, '202603071315423', '测试', 2030139388972785664, 1, 'PAID', '13844444444', '', '', '', '', 120.00, 290.00, 210.00, 70.00, 210.00, '', '2026-03-07 13:15:42', NULL, 'money', '2026-03-07 13:15:42', 'money', '2026-03-07 13:15:42', 0, 10.00, 0.00);
INSERT INTO `oms_order` VALUES (2030328634696601600, '202603080104027', '测试惠购', 2030124588037324800, 1, 'PAID', '13888888888', '', '', '', '', 75.00, 225.00, 135.50, 87.50, 135.50, '', '2026-03-08 01:04:03', NULL, 'money', '2026-03-08 01:04:03', 'money', '2026-03-08 01:04:03', 0, 0.00, 2.00);
INSERT INTO `oms_order` VALUES (2030329950273605632, '202603080109163', '测试', 2030139388972785664, 1, 'PAID', '13844444444', '', '', '', '', 60.00, 220.00, 140.00, 70.00, 140.00, '', '2026-03-08 01:09:16', NULL, 'money', '2026-03-08 01:09:17', 'money', '2026-03-08 01:09:17', 0, 10.00, 0.00);
INSERT INTO `oms_order` VALUES (2030473791943036928, '202603081040509', '测试', 2030139388972785664, 1, 'PAID', '13844444444', '', '', '', '', 0.00, 99.00, 99.00, 0.00, 99.00, '', '2026-03-08 10:40:51', NULL, 'money', '2026-03-08 10:40:51', 'money', '2026-03-08 10:40:51', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2030486387689623552, '202603081130531', '测试', 2030139388972785664, 1, 'PAID', '13844444444', '', '', '', '', 300.00, 760.00, 543.00, 185.00, 543.00, '', '2026-03-08 11:30:54', NULL, 'money', '2026-03-08 11:30:54', 'money', '2026-03-08 11:30:54', 0, 30.00, 2.00);
INSERT INTO `oms_order` VALUES (2030513142861160448, '202603081317125', '测试', 2030139388972785664, 1, 'PAID', '13844444444', '', '', '', '', 66.00, 198.00, 110.00, 77.00, 66.00, '', '2026-03-08 13:17:13', NULL, 'money', '2026-03-08 13:17:13', 'money', '2026-03-08 13:17:13', 0, 10.00, 1.00);
INSERT INTO `oms_order` VALUES (2030558113760927744, '202603081615544', '测试', 2030139388972785664, 1, 'PAID', '13844444444', '', '', '', '', 153.00, 459.00, 251.00, 178.00, 251.00, '', '2026-03-08 16:15:55', NULL, 'money', '2026-03-08 16:15:55', 'money', '2026-03-08 16:15:55', 0, 20.00, 10.00);
INSERT INTO `oms_order` VALUES (2030560010370670592, '202603081623279', '测试', 2030139388972785664, 1, 'PAID', '13844444444', '', '', '', '', 59820.00, 109740.00, 108660.00, 70.00, 108660.00, '', '2026-03-08 16:23:27', NULL, 'money', '2026-03-08 16:23:27', 'money', '2026-03-08 16:23:27', 0, 10.00, 1000.00);
INSERT INTO `oms_order` VALUES (2030560473451192320, '202603081625176', '测试', 2030139388972785664, 1, 'PAID', '13844444444', '', '', '', '', 58005.00, 106535.00, 104392.50, 122.50, 104392.50, '', '2026-03-08 16:25:17', NULL, 'money', '2026-03-08 16:25:18', 'money', '2026-03-08 16:25:18', 0, 20.00, 2000.00);
INSERT INTO `oms_order` VALUES (2030561317475180544, '202603081628382', '测试', 2030139388972785664, 1, 'PAID', '13844444444', '', '', '', '', 59075.00, 108327.21, 106728.72, 55.49, 106602.48, '', '2026-03-08 16:28:39', NULL, 'money', '2026-03-08 16:28:39', 'money', '2026-03-08 16:28:39', 0, 20.00, 1523.00);
INSERT INTO `oms_order` VALUES (2030853401100795904, '202603091149160', '测试', 2030139388972785664, 1, 'PAID', '13844444444', '', '', '', '', 153.00, 389.00, 261.00, 108.00, 261.00, '', '2026-03-09 11:49:17', NULL, 'money', '2026-03-09 11:49:17', 'money', '2026-03-09 11:49:17', 0, 10.00, 10.00);
INSERT INTO `oms_order` VALUES (2031405283982782464, '202603110022157', '测试', 2030139388972785664, 1, 'PAID', '13844444444', '', '', '', '', 3.00, 9.00, 6.00, 3.00, 6.00, '', '2026-03-11 00:22:16', NULL, 'money', '2026-03-11 00:22:16', 'money', '2026-03-11 00:22:16', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2031405337082671104, '202603110022284', '测试', 2030139388972785664, 1, 'PAID', '13844444444', '', '', '', '', 3.00, 9.00, 5.50, 3.50, 5.50, '', '2026-03-11 00:22:29', NULL, 'money', '2026-03-11 00:22:29', 'money', '2026-03-11 00:22:29', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2031405388928462848, '202603110022417', '测试', 2030139388972785664, 1, 'PAID', '13844444444', '', '', '', '', 3.00, 11.00, 7.50, 3.50, 7.50, '', '2026-03-11 00:22:41', NULL, 'money', '2026-03-11 00:22:41', 'money', '2026-03-11 00:22:41', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2031405456498700288, '202603110022578', '测试', 2030139388972785664, 1, 'PAID', '13844444444', '', '', '', '', 5.00, 9.91, 8.12, 1.79, 8.12, '', '2026-03-11 00:22:57', NULL, 'money', '2026-03-11 00:22:57', 'money', '2026-03-11 00:22:57', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2031567423809036288, '202603111106330', '测试', 2030139388972785664, 1, 'RETURN', '13844444444', '', '', '', '', 3.00, 9.00, 6.00, 3.00, 0.00, '', '2026-03-11 11:06:33', NULL, 'money', '2026-03-11 11:06:33', 'money', '2026-03-11 11:06:33', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2031598726935773184, '202603111310564', '测试开卡2', 2030324533690699776, 1, 'PAID', '13322222222', '', '', '', '', 3.00, 9.00, 5.00, 4.00, 5.00, '', '2026-03-11 13:10:56', NULL, 'money', '2026-03-11 13:10:56', 'money', '2026-03-11 13:10:56', 0, 0.00, 0.00);
INSERT INTO `oms_order` VALUES (2031598874596245504, '202603111311317', '测试宛伊钻石', 2030132309080010752, 1, 'PAID', '13833333333', '', '', '', '', 3.00, 9.00, 9.00, 0.00, 9.00, '', '2026-03-11 13:11:32', NULL, 'money', '2026-03-11 13:11:32', 'money', '2026-03-11 13:11:32', 0, 0.00, 0.00);
...
CREATE TABLE `oms_order_detail`  (
  ...
  `status` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '状态',
  `goods_id` bigint NOT NULL COMMENT '商品id',
  `brand_id` bigint NULL DEFAULT NULL COMMENT '品牌ID(数据冗余，专为报表提速)',
...
-- ----------------------------
INSERT INTO `oms_order_detail` VALUES (2028323606729375744, '202603021216460', 'PAID', 2028320220193800192, NULL, '0000', '测试2', 60.00, 5, 90.00, 100.00, 80.00, 30.00, 0, 'money', '2026-03-02 12:16:47', 'money', '2026-03-02 12:16:47', 0);
INSERT INTO `oms_order_detail` VALUES (2028324090433290240, '202603021218429', 'PAID', 2028323925618114560, NULL, '00000', '测试2', 20.00, 10, 50.00, 10.00, 40.00, 30.00, 0, 'money', '2026-03-02 12:18:42', 'money', '2026-03-02 12:18:42', 0);
INSERT INTO `oms_order_detail` VALUES (2028456145418743808, '202603022103261', 'PAID', 2028320220193800192, NULL, '0000', '测试2', 60.00, 2, 90.00, 100.00, 80.00, 30.00, 0, 'money', '2026-03-02 21:03:27', 'money', '2026-03-02 21:03:27', 0);
INSERT INTO `oms_order_detail` VALUES (2028456816578686976, '202603022106068', 'PAID', 2028320220193800192, NULL, '0000', '测试2', 60.00, 6, 90.00, 100.00, 80.00, 30.00, 0, 'money', '2026-03-02 21:06:07', 'money', '2026-03-02 21:06:07', 0);
INSERT INTO `oms_order_detail` VALUES (2028456816595464192, '202603022106068', 'PAID', 1488070478168899586, NULL, '6955470960313', '日用', 5.00, 6, 9.00, 3.47, 5.00, 4.00, 0, 'money', '2026-03-02 21:06:07', 'money', '2026-03-02 21:06:07', 0);
INSERT INTO `oms_order_detail` VALUES (2028462940639993856, '202603022130269', 'PAID', 2028320220193800192, NULL, '0000', '测试2', 60.00, 1, 90.00, 100.00, 80.00, 30.00, 0, 'money', '2026-03-02 21:30:27', 'money', '2026-03-02 21:30:27', 0);
INSERT INTO `oms_order_detail` VALUES (2028497769679085568, '202603022348501', 'PAID', 2028320220193800192, NULL, '0000', '测试2', 80.00, 2, 90.00, 100.00, 80.00, 10.00, 0, 'money', '2026-03-02 23:48:51', 'money', '2026-03-02 23:48:51', 0);
INSERT INTO `oms_order_detail` VALUES (2028498367417737216, '202603022351133', 'PAID', 2028320220193800192, NULL, '0000', '测试2', 80.00, 2, 90.00, 100.00, 80.00, 10.00, 0, 'money', '2026-03-02 23:51:13', 'money', '2026-03-02 23:51:13', 0);
INSERT INTO `oms_order_detail` VALUES (2028498858516209664, '202603022353106', 'PAID', 2028320220193800192, NULL, '0000', '测试2', 80.00, 4, 90.00, 100.00, 80.00, 10.00, 0, 'money', '2026-03-02 23:53:10', 'money', '2026-03-02 23:53:10', 0);
INSERT INTO `oms_order_detail` VALUES (2028499652657340416, '202603022356197', 'PAID', 2028320220193800192, NULL, '0000', '测试2', 80.00, 2, 90.00, 100.00, 80.00, 10.00, 0, 'money', '2026-03-02 23:56:20', 'money', '2026-03-02 23:56:20', 0);
INSERT INTO `oms_order_detail` VALUES (2028501921402482688, '202603030005207', 'PAID', 2028320220193800192, NULL, '0000', '测试2', 80.00, 2, 90.00, 100.00, 80.00, 10.00, 0, 'money', '2026-03-03 00:05:20', 'money', '2026-03-03 00:05:20', 0);
INSERT INTO `oms_order_detail` VALUES (2029403819819159552, '202603051149091', 'PAID', 1488070478168899586, NULL, '6955470960313', '日用', 5.00, 50, 9.00, 3.47, 5.00, 4.00, 0, 'money', '2026-03-05 11:49:10', 'money', '2026-03-05 11:49:10', 0);
INSERT INTO `oms_order_detail` VALUES (2029405175430795264, '202603051154325', 'PAID', 1488070478168899586, NULL, '6955470960313', '日用', 5.00, 50, 9.00, 3.47, 5.00, 4.00, 0, 'money', '2026-03-05 11:54:33', 'money', '2026-03-05 11:54:33', 0);
INSERT INTO `oms_order_detail` VALUES (2029412683595698176, '202603051224225', 'PAID', 1488070478168899586, NULL, '6955470960313', '日用', 5.00, 30, 9.00, 3.47, 5.00, 4.00, 2, 'money', '2026-03-05 12:24:23', 'money', '2026-03-05 12:24:23', 0);
INSERT INTO `oms_order_detail` VALUES (2029414273119473664, '202603051230420', 'PAID', 1488070478168899586, NULL, '6955470960313', '日用', 5.00, 25, 9.00, 3.47, 5.00, 0.00, 0, 'money', '2026-03-05 12:30:42', 'money', '2026-03-05 12:30:42', 0);
INSERT INTO `oms_order_detail` VALUES (2029495188252372992, '202603051752138', 'RETURN', 1488070478168899586, NULL, '6955470960313', '日用', 5.00, 30, 9.00, 3.47, 5.00, 4.00, 30, 'money', '2026-03-05 17:52:14', 'money', '2026-03-05 17:52:14', 0);
INSERT INTO `oms_order_detail` VALUES (2029522051431510016, '202603051938583', 'RETURN', 1488070478168899586, NULL, '6955470960313', '日用', 9.00, 1, 9.00, 3.47, 5.00, 0.00, 1, 'money', '2026-03-05 19:38:58', 'money', '2026-03-05 19:38:58', 0);
INSERT INTO `oms_order_detail` VALUES (2029525028397494272, '202603051950484', 'RETURN', 1488072124630351874, NULL, '6955470939777', '臻享迷你巾', 6.00, 1, 12.00, 4.72, 6.00, 6.00, 1, 'money', '2026-03-05 19:50:48', 'money', '2026-03-05 19:50:48', 0);
INSERT INTO `oms_order_detail` VALUES (2029525028405882880, '202603051950484', 'RETURN', 1488070478168899586, NULL, '6955470960313', '日用', 5.00, 1, 9.00, 3.47, 5.00, 4.00, 1, 'money', '2026-03-05 19:50:48', 'money', '2026-03-05 19:50:48', 0);
INSERT INTO `oms_order_detail` VALUES (2029525028405882881, '202603051950484', 'RETURN', 1488070069522055170, NULL, '6955470960320', '夜用', 5.00, 1, 9.00, 3.47, 5.00, 4.00, 1, 'money', '2026-03-05 19:50:48', 'money', '2026-03-05 19:50:48', 0);
INSERT INTO `oms_order_detail` VALUES (2029525028410077184, '202603051950484', 'RETURN', 1487743593950072833, NULL, '6955470960344', '护垫', 6.00, 1, 11.00, 4.54, 6.00, 5.00, 1, 'money', '2026-03-05 19:50:48', 'money', '2026-03-05 19:50:48', 0);
INSERT INTO `oms_order_detail` VALUES (2029748995192291328, '202603061040450', 'PAID', 1488070478168899586, NULL, '6955470960313', '日用', 5.00, 20, 9.00, 3.47, 5.00, 4.00, 0, 'money', '2026-03-06 10:40:46', 'money', '2026-03-06 10:40:46', 0);
INSERT INTO `oms_order_detail` VALUES (2029752045827031040, '202603061052534', 'PAID', 1488070478168899586, NULL, '6955470960313', '日用', 5.00, 1, 9.00, 3.47, 5.00, 4.00, 0, 'money', '2026-03-06 10:52:53', 'money', '2026-03-06 10:52:53', 0);
INSERT INTO `oms_order_detail` VALUES (2029768273123639296, '202603061157229', 'PAID', 1488070069522055170, NULL, '6955470960320', '夜用', 5.00, 1, 9.00, 3.47, 5.00, 4.00, 0, 'money', '2026-03-06 11:57:22', 'money', '2026-03-06 11:57:22', 0);
INSERT INTO `oms_order_detail` VALUES (2029771955877744640, '202603061212006', 'PAID', 1488071281298423809, NULL, '6955470960337', '加长360', 6.50, 1, 12.50, 5.13, 6.50, 6.00, 0, 'money', '2026-03-06 12:12:00', 'money', '2026-03-06 12:12:00', 0);
INSERT INTO `oms_order_detail` VALUES (2029771955881938944, '202603061212006', 'PAID', 1488070069522055170, NULL, '6955470960320', '夜用', 5.00, 2, 9.00, 3.47, 5.00, 4.00, 0, 'money', '2026-03-06 12:12:00', 'money', '2026-03-06 12:12:00', 0);
INSERT INTO `oms_order_detail` VALUES (2029771955886133248, '202603061212006', 'PAID', 1488070478168899586, NULL, '6955470960313', '日用', 5.00, 1, 9.00, 3.47, 5.00, 4.00, 0, 'money', '2026-03-06 12:12:00', 'money', '2026-03-06 12:12:00', 0);
INSERT INTO `oms_order_detail` VALUES (2029775115170144256, '202603061224334', 'PAID', 1488070478168899586, NULL, '6955470960313', '日用', 5.00, 20, 9.00, 3.47, 5.00, 4.00, 0, 'money', '2026-03-06 12:24:34', 'money', '2026-03-06 12:24:34', 0);
INSERT INTO `oms_order_detail` VALUES (2029889990693330944, '202603062001011', 'PAID', 1487743593950072833, NULL, '6955470960344', '护垫', 6.00, 20, 11.00, 4.54, 6.00, 5.00, 0, 'money', '2026-03-06 20:01:02', 'money', '2026-03-06 20:01:02', 0);
INSERT INTO `oms_order_detail` VALUES (2029889990705913856, '202603062001011', 'PAID', 1488070478168899586, NULL, '6955470960313', '日用', 5.00, 1, 9.00, 3.47, 5.00, 4.00, 0, 'money', '2026-03-06 20:01:02', 'money', '2026-03-06 20:01:02', 0);
INSERT INTO `oms_order_detail` VALUES (2029892132812386304, '202603062009325', 'PAID', 1488073045384937473, NULL, '6955470983787', '洋甘菊眼罩', 19.00, 10, 29.00, 17.00, 19.00, 10.00, 0, 'money', '2026-03-06 20:09:33', 'money', '2026-03-06 20:09:33', 0);
INSERT INTO `oms_order_detail` VALUES (2029895245896142848, '202603062021545', 'PAID', 1488079493057789954, NULL, '6955470983800', '绿茶眼罩', 19.00, 7, 29.00, 17.00, 19.00, 10.00, 0, 'money', '2026-03-06 20:21:55', 'money', '2026-03-06 20:21:55', 0);
INSERT INTO `oms_order_detail` VALUES (2029900099079131136, '202603062041118', 'PAID', 1488079493057789954, NULL, '6955470983800', '绿茶眼罩', 19.00, 6, 29.00, 17.00, 19.00, 10.00, 0, 'money', '2026-03-06 20:41:12', 'money', '2026-03-06 20:41:12', 0);
INSERT INTO `oms_order_detail` VALUES (2029900450045906944, '202603062042351', 'PAID', 1488079493057789954, NULL, '6955470983800', '绿茶眼罩', 19.00, 6, 29.00, 17.00, 19.00, 10.00, 0, 'money', '2026-03-06 20:42:36', 'money', '2026-03-06 20:42:36', 0);
INSERT INTO `oms_order_detail` VALUES (2029902566009360384, '202603062051003', 'PAID', 1488072124630351874, NULL, '6955470939777', '臻享迷你巾', 6.00, 20, 12.00, 4.72, 6.00, 6.00, 0, 'money', '2026-03-06 20:51:00', 'money', '2026-03-06 20:51:00', 0);
INSERT INTO `oms_order_detail` VALUES (2029903077257269248, '202603062053027', 'PAID', 1488070478168899586, NULL, '6955470960313', '日用', 5.00, 10, 9.00, 3.47, 5.00, 4.00, 0, 'money', '2026-03-06 20:53:02', 'money', '2026-03-06 20:53:02', 0);
INSERT INTO `oms_order_detail` VALUES (2029903077265657856, '202603062053027', 'PAID', 1487743593950072833, NULL, '6955470960344', '护垫', 6.00, 10, 11.00, 4.54, 6.00, 5.00, 0, 'money', '2026-03-06 20:53:02', 'money', '2026-03-06 20:53:02', 0);
INSERT INTO `oms_order_detail` VALUES (2029907190409916416, '202603062109224', 'PAID', 1488073045384937473, NULL, '6955470983787', '洋甘菊眼罩', 19.00, 10, 29.00, 17.00, 19.00, 10.00, 1, 'money', '2026-03-06 21:09:23', 'money', '2026-03-06 21:09:23', 0);
INSERT INTO `oms_order_detail` VALUES (2030139973717483520, '202603071234228', 'PAID', 2030133785449852928, NULL, '60313', '测试日用', 5.50, 20, 9.00, 3.00, 0.00, 3.50, 0, 'money', '2026-03-07 12:34:23', 'money', '2026-03-07 12:34:23', 0);
INSERT INTO `oms_order_detail` VALUES (2030139973721677824, '202603071234228', 'PAID', 2030133958737522688, NULL, '000000', '测试宛伊', 110.00, 1, 110.00, 60.00, 0.00, 0.00, 0, 'money', '2026-03-07 12:34:23', 'money', '2026-03-07 12:34:23', 0);
INSERT INTO `oms_order_detail` VALUES (2030149483228053504, '202603071312097', 'PAID', 2030133958737522688, NULL, '000000', '测试宛伊', 110.00, 1, 110.00, 60.00, 0.00, 0.00, 0, 'money', '2026-03-07 13:12:10', 'money', '2026-03-07 13:12:10', 0);
INSERT INTO `oms_order_detail` VALUES (2030149483236442112, '202603071312097', 'PAID', 2030133785449852928, NULL, '60313', '测试日用', 5.50, 2, 9.00, 3.00, 0.00, 3.50, 0, 'money', '2026-03-07 13:12:10', 'money', '2026-03-07 13:12:10', 0);
INSERT INTO `oms_order_detail` VALUES (2030150373880119296, '202603071315423', 'PAID', 2030133958737522688, NULL, '000000', '测试宛伊', 110.00, 1, 110.00, 60.00, 0.00, 0.00, 0, 'money', '2026-03-07 13:15:42', 'money', '2026-03-07 13:15:42', 0);
INSERT INTO `oms_order_detail` VALUES (2030150373880119297, '202603071315423', 'PAID', 2030149135247622144, NULL, '60320', '测试夜用', 5.50, 10, 9.00, 3.00, 0.00, 3.50, 0, 'money', '2026-03-07 13:15:42', 'money', '2026-03-07 13:15:42', 0);
INSERT INTO `oms_order_detail` VALUES (2030150373884313600, '202603071315423', 'PAID', 2030133785449852928, NULL, '60313', '测试日用', 5.50, 10, 9.00, 3.00, 0.00, 3.50, 0, 'money', '2026-03-07 13:15:42', 'money', '2026-03-07 13:15:42', 0);
INSERT INTO `oms_order_detail` VALUES (2030328634772099072, '202603080104027', 'PAID', 2030149135247622144, NULL, '60320', '测试夜用', 5.50, 25, 9.00, 3.00, 0.00, 3.50, 0, 'money', '2026-03-08 01:04:03', 'money', '2026-03-08 01:04:03', 0);
INSERT INTO `oms_order_detail` VALUES (2030329950294577152, '202603080109163', 'PAID', 2030167929437319168, NULL, '60337', '测试夜用加长', 7.50, 20, 11.00, 3.00, 0.00, 3.50, 0, 'money', '2026-03-08 01:09:17', 'money', '2026-03-08 01:09:17', 0);
INSERT INTO `oms_order_detail` VALUES (2030473791993368576, '202603081040509', 'PAID', 2030473430092042240, NULL, '303333', '测试套餐', 99.00, 1, 99.00, 0.00, 0.00, 0.00, 0, 'money', '2026-03-08 10:40:51', 'money', '2026-03-08 10:40:51', 0);
INSERT INTO `oms_order_detail` VALUES (2030486387781898240, '202603081130531', 'PAID', 2030133785449852928, NULL, '60313', '测试日用', 6.00, 50, 9.00, 3.00, 0.00, 3.00, 0, 'money', '2026-03-08 11:30:54', 'money', '2026-03-08 11:30:54', 0);
INSERT INTO `oms_order_detail` VALUES (2030486387790286848, '202603081130531', 'PAID', 2030133958737522688, NULL, '000000', '测试宛伊', 110.00, 2, 110.00, 60.00, 0.00, 0.00, 0, 'money', '2026-03-08 11:30:54', 'money', '2026-03-08 11:30:54', 0);
INSERT INTO `oms_order_detail` VALUES (2030486387794481152, '202603081130531', 'PAID', 2030149135247622144, NULL, '60320', '测试夜用', 5.50, 10, 9.00, 3.00, 0.00, 3.50, 0, 'money', '2026-03-08 11:30:54', 'money', '2026-03-08 11:30:54', 0);
INSERT INTO `oms_order_detail` VALUES (2030513142924075008, '202603081317125', 'PAID', 2030149135247622144, NULL, '60320', '测试夜用', 5.50, 22, 9.00, 3.00, 0.00, 3.50, 8, 'money', '2026-03-08 13:17:13', 'money', '2026-03-08 13:17:13', 0);
INSERT INTO `oms_order_detail` VALUES (2030558113823842304, '202603081615544', 'PAID', 2030149135247622144, NULL, '60320', '测试夜用', 5.50, 50, 9.00, 3.00, 0.00, 3.50, 0, 'money', '2026-03-08 16:15:55', 'money', '2026-03-08 16:15:55', 0);
INSERT INTO `oms_order_detail` VALUES (2030558113828036608, '202603081615544', 'PAID', 2030133785449852928, NULL, '60313', '测试日用', 6.00, 1, 9.00, 3.00, 0.00, 3.00, 0, 'money', '2026-03-08 16:15:55', 'money', '2026-03-08 16:15:55', 0);
INSERT INTO `oms_order_detail` VALUES (2030560010391642112, '202603081623279', 'PAID', 2030133958737522688, NULL, '000000', '测试宛伊', 110.00, 996, 110.00, 60.00, 0.00, 0.00, 0, 'money', '2026-03-08 16:23:27', 'money', '2026-03-08 16:23:27', 0);
INSERT INTO `oms_order_detail` VALUES (2030560010395836416, '202603081623279', 'PAID', 2030149135247622144, NULL, '60320', '测试夜用', 5.50, 20, 9.00, 3.00, 0.00, 3.50, 0, 'money', '2026-03-08 16:23:27', 'money', '2026-03-08 16:23:27', 0);
INSERT INTO `oms_order_detail` VALUES (2030560473480552448, '202603081625176', 'PAID', 2030133958737522688, NULL, '000000', '测试宛伊', 110.00, 965, 110.00, 60.00, 0.00, 0.00, 0, 'money', '2026-03-08 16:25:18', 'money', '2026-03-08 16:25:18', 0);
INSERT INTO `oms_order_detail` VALUES (2030560473484746752, '202603081625176', 'PAID', 2030167929437319168, NULL, '60337', '测试夜用加长', 7.50, 35, 11.00, 3.00, 0.00, 3.50, 0, 'money', '2026-03-08 16:25:18', 'money', '2026-03-08 16:25:18', 0);
INSERT INTO `oms_order_detail` VALUES (2030561317508734976, '202603081628382', 'PAID', 2030560888028782592, NULL, '60341', '测试牙膏', 8.12, 31, 9.91, 5.00, 0.00, 1.79, 2, 'money', '2026-03-08 16:28:39', 'money', '2026-03-08 16:28:39', 0);
INSERT INTO `oms_order_detail` VALUES (2030561317512929280, '202603081628382', 'PAID', 2030133958737522688, NULL, '000000', '测试宛伊', 110.00, 982, 110.00, 60.00, 0.00, 0.00, 1, 'money', '2026-03-08 16:28:39', 'money', '2026-03-08 16:28:39', 0);
INSERT INTO `oms_order_detail` VALUES (2030853401167904768, '202603091149160', 'PAID', 2030149135247622144, NULL, '60320', '测试夜用', 5.50, 30, 9.00, 3.00, 0.00, 3.50, 0, 'money', '2026-03-09 11:49:17', 'money', '2026-03-09 11:49:17', 0);
INSERT INTO `oms_order_detail` VALUES (2030853401176293376, '202603091149160', 'PAID', 2030133785449852928, NULL, '60313', '测试日用', 6.00, 1, 9.00, 3.00, 0.00, 3.00, 0, 'money', '2026-03-09 11:49:17', 'money', '2026-03-09 11:49:17', 0);
INSERT INTO `oms_order_detail` VALUES (2030853401176293377, '202603091149160', 'PAID', 2030133958737522688, NULL, '000000', '测试宛伊', 110.00, 1, 110.00, 60.00, 0.00, 0.00, 0, 'money', '2026-03-09 11:49:17', 'money', '2026-03-09 11:49:17', 0);
INSERT INTO `oms_order_detail` VALUES (2031405284075057152, '202603110022157', 'PAID', 2030133785449852928, 2029044459821604864, '60313', '测试日用', 6.00, 1, 9.00, 3.00, 0.00, 3.00, 0, 'money', '2026-03-11 00:22:16', 'money', '2026-03-11 00:22:16', 0);
INSERT INTO `oms_order_detail` VALUES (2031405337107836928, '202603110022284', 'PAID', 2030149135247622144, 2029044459821604864, '60320', '测试夜用', 5.50, 1, 9.00, 3.00, 0.00, 3.50, 0, 'money', '2026-03-11 00:22:29', 'money', '2026-03-11 00:22:29', 0);
INSERT INTO `oms_order_detail` VALUES (2031405388962017280, '202603110022417', 'PAID', 2030167929437319168, 2029044459821604864, '60337', '测试夜用加长', 7.50, 1, 11.00, 3.00, 0.00, 3.50, 0, 'money', '2026-03-11 00:22:41', 'money', '2026-03-11 00:22:41', 0);
INSERT INTO `oms_order_detail` VALUES (2031405456528060416, '202603110022578', 'PAID', 2030560888028782592, 2029044459821604864, '60341', '测试牙膏', 8.12, 1, 9.91, 5.00, 0.00, 1.79, 0, 'money', '2026-03-11 00:22:57', 'money', '2026-03-11 00:22:57', 0);
INSERT INTO `oms_order_detail` VALUES (2031567423850979328, '202603111106330', 'PAID', 2030133785449852928, 2029044459821604864, '60313', '测试日用', 6.00, 1, 9.00, 3.00, 0.00, 3.00, 0, 'money', '2026-03-11 11:06:33', 'money', '2026-03-11 11:06:33', 0);
INSERT INTO `oms_order_detail` VALUES (2031598726994493440, '202603111310564', 'PAID', 2030133785449852928, 2029044459821604864, '60313', '测试日用', 5.00, 1, 9.00, 3.00, 0.00, 4.00, 0, 'money', '2026-03-11 13:10:56', 'money', '2026-03-11 13:10:56', 0);
INSERT INTO `oms_order_detail` VALUES (2031598874617217024, '202603111311317', 'PAID', 2030133785449852928, 2029044459821604864, '60313', '测试日用', 9.00, 1, 9.00, 3.00, 0.00, 0.00, 0, 'money', '2026-03-11 13:11:32', 'money', '2026-03-11 13:11:32', 0);
...
CREATE TABLE `oms_order_pay`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_order_no`(`order_no` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 100 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '订单支付明细表 (支持动态组合支付)' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pos_coupon_rule`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '满减券规则模板表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pos_member_coupon`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键 (每一张发出去的券都有唯一的独立ID)',
  `member_id` bigint NOT NULL COMMENT '所属会员ID',
  `rule_id` bigint NOT NULL COMMENT '关联的券规则ID (对应 pos_coupon_rule 的 id)',
...
) ENGINE = InnoDB AUTO_INCREMENT = 202 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '会员满减券资产表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `pos_member_coupon` VALUES (70, 2030132125415632896, 1, 'UNUSED', NULL, '2026-03-07 12:04:53', NULL, '0');
INSERT INTO `pos_member_coupon` VALUES (71, 2030132125415632896, 1, 'UNUSED', NULL, '2026-03-07 12:04:53', NULL, '0');
...
INSERT INTO `pos_member_coupon` VALUES (94, 2030139388972785664, 1, 'UNUSED', NULL, '2026-03-07 12:33:30', NULL, '0');
INSERT INTO `pos_member_coupon` VALUES (95, 2030139388972785664, 1, 'UNUSED', NULL, '2026-03-07 12:33:30', NULL, '0');
INSERT INTO `pos_member_coupon` VALUES (96, 2030139388972785664, 1, 'UNUSED', NULL, '2026-03-07 12:33:30', NULL, '0');
INSERT INTO `pos_member_coupon` VALUES (97, 2030139388972785664, 1, 'UNUSED', NULL, '2026-03-07 12:33:30', NULL, '0');
INSERT INTO `pos_member_coupon` VALUES (98, 2030139388972785664, 1, 'UNUSED', NULL, '2026-03-07 12:33:30', NULL, '0');
INSERT INTO `pos_member_coupon` VALUES (99, 2030139388972785664, 1, 'UNUSED', NULL, '2026-03-07 12:33:30', NULL, '0');
...
CREATE TABLE `pos_sku_level_price`  (
  ...
  `sku_id` bigint NOT NULL COMMENT '商品SKU的ID',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 87 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商品等级价格关联表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `pos_sku_level_price` VALUES (83, 2030133785449852928, 'LY_HG', 6.00, '0', 3.00);
...
CREATE TABLE `sys_dict_detail`  (
  ...
  `cn_desc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '中文描述',
...
INSERT INTO `sys_dict_detail` VALUES (2031396154786570240, 'paySubTag', 'ALIPAY', '支付宝', '', 999, 0, 'money', '2026-03-10 23:45:59', 'money', '2026-03-10 23:45:59');
...
-- ----------------------------
INSERT INTO `sys_permission` VALUES (1501921151197130754, '系统管理', 'DIR', 0, 'sys-manage', '', 'system', 0, 0, '', '', 6, 9, 'admin', '2022-03-10 22:01:21', 'admin', '2022-03-10 23:06:45', 0);
...
INSERT INTO `sys_permission` VALUES (1629388418109894657, '会员管理', 'DIR', 0, 'ums', '', 'ums', 0, 0, '', '', 3, 3, 'money', '2023-02-25 15:50:46', 'money', '2023-02-25 15:50:46', 0);
...
INSERT INTO `sys_permission` VALUES (1629732061718999041, '营销管理', 'DIR', 0, 'oms', '', 'oms', 0, 0, '', '', 5, 5, 'money', '2023-02-26 14:36:17', 'money', '2023-02-26 14:36:17', 0);
...
INSERT INTO `sys_permission` VALUES (2029035603146084352, '资金流水', 'MENU', 1629388418109894657, 'app', '', 'member-log', 0, 0, 'Memberlog', 'ums/member/log', 0, 2, 'money', '2026-03-04 11:26:00', 'money', '2026-03-04 11:26:00', 0);
INSERT INTO `sys_permission` VALUES (2029761473867456512, '会员状态', 'MENU', 1629388418109894657, 'app', '', 'memberRecall', 0, 0, 'MemberRecall', 'ums/memberRecall/index', 0, 3, 'money', '2026-03-06 11:30:21', 'money', '2026-03-06 11:30:21', 0);
...
INSERT INTO `sys_role_permission_relation` VALUES (2028145199362080768, 1502278787507806210, 1502845638751055873, 0);
INSERT INTO `sys_role_permission_relation` VALUES (2028145199366275072, 2028143215712141312, 1502845638751055873, 0);
INSERT INTO `sys_role_permission_relation` VALUES (2028145199366275073, 1503753930130149377, 1502845638751055873, 0);
INSERT INTO `sys_role_permission_relation` VALUES (2028145199366275074, 1503754468678782978, 1502845638751055873, 0);
INSERT INTO `sys_role_permission_relation` VALUES (2028145199366275075, 1507371669973479425, 1502845638751055873, 0);
INSERT INTO `sys_role_permission_relation` VALUES (2028145199366275076, 1503738104236822529, 1502845638751055873, 0);
INSERT INTO `sys_role_permission_relation` VALUES (2028145199366275077, 1502863016289398785, 1502845638751055873, 0);
INSERT INTO `sys_role_permission_relation` VALUES (2028145199366275078, 1507371776840151041, 1502845638751055873, 0);
INSERT INTO `sys_role_permission_relation` VALUES (2028145199366275079, 1503754297878335489, 1502845638751055873, 0);
INSERT INTO `sys_role_permission_relation` VALUES (2028145199366275080, 1503736683986800642, 1502845638751055873, 0);
INSERT INTO `sys_role_permission_relation` VALUES (2028145199366275081, 1503754013445804034, 1502845638751055873, 0);
INSERT INTO `sys_role_permission_relation` VALUES (2028145199366275082, 1507371725170520065, 1502845638751055873, 0);
INSERT INTO `sys_role_permission_relation` VALUES (2028145199366275083, 1507371326556450818, 1502845638751055873, 0);
INSERT INTO `sys_role_permission_relation` VALUES (2028145199374663680, 1503738191579009025, 1502845638751055873, 0);
INSERT INTO `sys_role_permission_relation` VALUES (2028145199374663681, 1502863270971731970, 1502845638751055873, 0);
INSERT INTO `sys_role_permission_relation` VALUES (2028145199374663682, 1503753702563991553, 1502845638751055873, 0);
INSERT INTO `sys_role_permission_relation` VALUES (2028145199374663683, 1503754393558798337, 1502845638751055873, 0);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'money', '$2a$10$W6oaOSARIA3DsZy1DkdfUuqI3L7a885Ci7AYvpQK.9NGbeVhcZihi', 'money', 'https://i.postimg.cc/1RjgG5w3/batman.png', '18120800000', 'money@qq.com', '俺是一个超级管理员！', 1, 1, '2026-03-11 19:43:55', '', '2022-03-03 23:12:57', 'money', '2022-03-25 23:41:26', 0);
INSERT INTO `sys_user` VALUES (1502254138862391297, 'admin', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', 'admin', 'https://i.postimg.cc/Hny7JfS2/superhero.png', '18120803972', 'admin@qq.com', '', 1, 1, '2026-03-01 21:33:07', 'admin', '2022-03-11 20:04:32', 'money', '2022-03-25 23:41:06', 0);
...
CREATE TABLE `ums_member`  (
  ...
  `update_time` datetime NOT NULL,
  `tenant_id` bigint UNSIGNED NOT NULL DEFAULT 0 COMMENT '租户id',
  `level_id` bigint NULL DEFAULT NULL COMMENT '会员等级ID（关联 pos_member_level 表）',
...
INSERT INTO `ums_member` VALUES (2029032007205687296, '51978645', '张三2', 'MEMBER', '13800138002', 500.00, '', '', '', '', 0.00, 0.00, 0.00, 0, 0, '开业支持者', 1, 'money', '2026-03-04 11:11:43', 'money', '2026-03-04 11:11:43', 0, NULL, NULL);
...
INSERT INTO `ums_member` VALUES (2030124588037324800, '40392015', '测试惠购', 'MEMBER', '13888888888', 998.00, '', '', '', '', 912.50, 135.50, 87.50, 1, 0, '', 0, 'money', '2026-03-07 11:33:14', 'money', '2026-03-07 11:33:14', 0, NULL, '2026-03-08 01:04:03');
INSERT INTO `ums_member` VALUES (2030132125415632896, '75011789', '测试绿叶vip', 'MEMBER', '13800000000', 1000.00, '', '', '', '', 1000.00, 0.00, 0.00, 0, 0, '', 0, 'money', '2026-03-07 12:03:11', 'money', '2026-03-07 12:03:11', 0, NULL, NULL);
INSERT INTO `ums_member` VALUES (2030132234534645760, '54320057', '测试宛伊天使', 'MEMBER', '13822222222', 100.00, '', '', '', '', 100.00, 0.00, 0.00, 0, 0, '', 0, 'money', '2026-03-07 12:03:37', 'money', '2026-03-07 12:03:37', 0, NULL, NULL);
...
INSERT INTO `ums_member` VALUES (2030139388972785664, '73782978', '测试', 'MEMBER', '13844444444', 26.77, '', '', '', '', 2523.80, 321593.10, 1024.78, 16, 1, '', 0, 'money', '2026-03-07 12:32:03', 'money', '2026-03-07 12:32:03', 0, NULL, '2026-03-11 11:06:33');
...
INSERT INTO `ums_member` VALUES (2030324656814493696, '18493014', '测试宛', 'WY_TS', '13333333333', 0.00, '', '', '', '', 200.00, 0.00, 0.00, 0, 0, '', 0, 'money', '2026-03-08 00:48:14', 'money', '2026-03-08 00:48:14', 0, NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 55 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '会员多品牌身份矩阵表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `ums_member_brand_level` VALUES (10, 2029032007205687296, '2029044459821604864', 'HJ_VIP', '2026-03-07 00:43:00', '2026-03-07 00:43:00', 0);
INSERT INTO `ums_member_brand_level` VALUES (11, 2029032007205687296, '2029044546069078016', 'BJ_VIP', '2026-03-07 00:43:00', '2026-03-07 00:43:00', 0);
INSERT INTO `ums_member_brand_level` VALUES (12, 2029032007205687296, '2029044567510360064', 'INNER', '2026-03-07 00:43:00', '2026-03-07 00:43:00', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 151 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '会员本金与存券变动流水表' ROW_FORMAT = DYNAMIC;
...
-- 1. 尝试建立配置大类（如果不存在则插入）
INSERT IGNORE INTO `sys_dict` (`id`, `dict_name`, `dict_desc`, `create_by`, `create_time`, `update_by`, `update_time`)
VALUES (1775000000000, 'SYSTEM_SETTING', '系统核心配置仓', 'admin', NOW(), 'admin', NOW());

-- 2. 尝试建立客显配置专属条目
INSERT IGNORE INTO `sys_dict_detail` (`id`, `dict`, `value`, `cn_desc`, `en_desc`, `sort`, `hidden`, `create_by`, `create_time`, `update_by`, `update_time`)
VALUES (1775000000001, 'SYSTEM_SETTING', 'customer_display', '{}', 'Customer Display Settings', 1, 0, 'admin', NOW(), 'admin', NOW());

-- 🌟 架构扩容：将配置容器字段由 VARCHAR(255) 升级为 TEXT (可容纳6万字)，确保JSON不溢出
ALTER TABLE `sys_dict_detail` MODIFY COLUMN `cn_desc` TEXT;
